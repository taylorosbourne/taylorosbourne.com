  ...
  <form name="contact" method="post" action="/thanks" data-netlify="true" data-netlify-honeypot="bot-field" style={{
    ...
    <p>
      <ul style={{listStyle: `none`}}>
        <li><span role="img" aria-label="email">📬</span> <StyledAnchorLink 
        ...
        <li><span role="img" aria-label="github">👨‍💻</span> <StyledAnchorLink 
        ...
        <li><span role="img" aria-label="linkedin">👨‍💼</span> <StyledAnchorLink 
    ...
    <p>
      <SubmitButton type="submit">submit <span role="img" aria-label="submit-yay"> 🎉</span></SubmitButton>
    </p>
    </div>
    </div>
  </form>
